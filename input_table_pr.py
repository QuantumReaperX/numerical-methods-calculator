...
from polynomialoutput import Ui_PolynomialRegressionResult


class Ui_InputDataPR(object):
    def setupUi(self, Form):
        ...
        self.pushButton.setStyleSheet("QPushButton { background-color: rgb(150, 180, 10); color: rgb(250, 250, 250)}")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Polynomial Data Input"))
    ...
    def calculate_button(self):
        ...
        self.ui = Ui_PolynomialRegressionResult()
